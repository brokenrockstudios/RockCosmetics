...
#include "RockCosmeticAnimationTypes.generated.h"
...
struct FRockAnimLayerSelectionEntry
{
	GENERATED_BODY()
...
USTRUCT(BlueprintType)
struct ROCKCOSMETICS_API FRockAnimLayerSelectionSet
{
	GENERATED_BODY()
	...
	TArray<FRockAnimLayerSelectionEntry> LayerRules;
...
USTRUCT(BlueprintType)
struct FRockAnimBodyStyleSelectionEntry
{
	GENERATED_BODY()
...
struct FRockAnimBodyStyleSelectionSet
{
	...
	TArray<FRockAnimBodyStyleSelectionEntry> MeshRules;
